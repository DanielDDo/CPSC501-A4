...
struct WAV{
  ...
  void combineRealAndImaginary(vector<double> &x, vector<double> &x2, vector<double> &h, vector<double> &h2) {
    ...
    if (i == newSize-4) {
      x2.push_back(x[newSize-4]);
      x2.push_back(0.0);
      x2.push_back(x[newSize-3]);
      x2.push_back(0.0);
      x2.push_back(x[newSize-2]);
      x2.push_back(0.0);
      x2.push_back(x[newSize-1]);
      x2.push_back(0.0);
      h2.push_back(h[newSize-4]);
      h2.push_back(0.0);
      h2.push_back(h[newSize-3]);
      h2.push_back(0.0);
      h2.push_back(h[newSize-2]);
      h2.push_back(0.0);
      h2.push_back(h[newSize-1]);
      h2.push_back(0.0);
    } else if (i == newSize-3) {
      x2.push_back(x[newSize-3]);
      x2.push_back(0.0);
